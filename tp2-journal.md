...
4. Test de mise à jour (Version 1.0.1)
...
### 6. Optimisation du Dockerfile et Multi-stage Build
...
### 7. Déploiement automatisé de la version 1.0.1
...
### 8. Analyse du gain d'espace disque
...
9. Tests de robustesse et Rollback
...
### Étape 5 : Optimisation de l'image (Multi-stage build)
...
### etape 6 : Robustesse du script de déploiement (Image 11)
...
### Étape 7 : Persistance et Redémarrage automatique (Image 12)
